---
name: terraform
description: Terraform engineering for module boundaries, state, providers, plans, drift, imports, secrets, and safe infrastructure changes.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Terraform engineering for module boundaries, state, providers, plans, drift, imports, secrets, and safe infrastructure changes."
  layer: infrastructure
---

# Terraform

Own backend and workspace evidence, state ownership, variable sensitivity, plan review, dependency graph, least privilege, and idempotent apply checks. Activate for tasks that explicitly involve terraform, iac, state, providers; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

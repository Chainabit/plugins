---
name: docker
description: Docker engineering for minimal images, build context, layer reuse, runtime users, secrets, health, and reproducible builds.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Docker engineering for minimal images, build context, layer reuse, runtime users, secrets, health, and reproducible builds."
  layer: infrastructure
---

# Docker

Own actual Dockerfile and base digest policy, multi-stage ownership, non-root runtime, build secret handling, probe semantics, and image scanning. Activate for tasks that explicitly involve docker, containers, images, buildkit; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

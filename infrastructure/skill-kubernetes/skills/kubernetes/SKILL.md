---
name: kubernetes
description: Kubernetes engineering for workload ownership, probes, resources, rollout, configuration, security context, and troubleshooting.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Kubernetes engineering for workload ownership, probes, resources, rollout, configuration, security context, and troubleshooting."
  layer: infrastructure
---

# Kubernetes

Own cluster/version and manifests, controller ownership, readiness versus liveness, resource evidence, RBAC, secret references, and rollout verification. Activate for tasks that explicitly involve kubernetes, k8s, deployments, rbac; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

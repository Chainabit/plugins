---
name: pulumi
description: Pulumi engineering for typed infrastructure, stack state, previews, secrets, component resources, and safe replacements.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Pulumi engineering for typed infrastructure, stack state, previews, secrets, component resources, and safe replacements."
  layer: infrastructure
---

# Pulumi

Own language/runtime and provider evidence, component ownership, preview diff, secret providers, protect/replace semantics, and policy checks. Activate for tasks that explicitly involve pulumi, iac, cloud, stacks; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

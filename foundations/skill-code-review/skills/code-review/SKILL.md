---
name: code-review
description: Code review for correctness, security, compatibility, operability, tests, and maintainable responsibility boundaries.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Code review for correctness, security, compatibility, operability, tests, and maintainable responsibility boundaries."
  layer: foundations
---

# Code Review

Own review diff and surrounding contracts, prioritize concrete failure modes, distinguish blockers from suggestions, and require evidence for claims. Activate for tasks that explicitly involve code-review, defects, risk, maintainability; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

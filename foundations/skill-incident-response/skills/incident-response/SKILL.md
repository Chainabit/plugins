...
description: Incident-response engineering for triage, containment, communication, evidence preservation, recovery, and learning.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Incident-response engineering for triage, containment, communication, evidence preservation, recovery, and learning."
  layer: foundations
---

# Incident Response

Own impact and timeline evidence, reversible containment, least-privilege access, customer-safe communication, recovery validation, and blameless follow-up. Activate for tasks that explicitly involve incidents, on-call, recovery, postmortem; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

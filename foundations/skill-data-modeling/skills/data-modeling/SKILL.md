---
name: data-modeling
description: Data modeling for durable domain meaning, identifiers, temporal state, ownership, lineage, and interoperability.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Data modeling for durable domain meaning, identifiers, temporal state, ownership, lineage, and interoperability."
  layer: foundations
---

# Data Modeling

Own source-of-truth ownership, nullability, identity, temporal semantics, compatibility, retention, and representative data tests. Activate for tasks that explicitly involve data-modeling, domains, lineage, schemas; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

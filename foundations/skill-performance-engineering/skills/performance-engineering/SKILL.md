...
description: Performance engineering for hypotheses, budgets, profiling, capacity, regressions, and cost-aware optimization.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Performance engineering for hypotheses, budgets, profiling, capacity, regressions, and cost-aware optimization."
  layer: foundations
---

# Performance Engineering

Own workload and SLO evidence, representative benchmarks, profiling before changes, bottleneck ownership, and statistically sound comparisons. Activate for tasks that explicitly involve performance, profiling, benchmarks, capacity; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

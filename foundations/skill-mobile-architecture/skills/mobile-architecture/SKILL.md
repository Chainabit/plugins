...
description: Mobile architecture for lifecycle, navigation, offline state, synchronization, capabilities, accessibility, and release constraints.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Mobile architecture for lifecycle, navigation, offline state, synchronization, capabilities, accessibility, and release constraints."
  layer: foundations
---

# Mobile Architecture

Own platform lifecycle and connectivity evidence, state ownership, sync conflict policy, permission timing, secure storage, and device testing. Activate for tasks that explicitly involve mobile, ios, android, offline; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

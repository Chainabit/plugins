---
name: observability
description: Observability engineering for useful logs, metrics, traces, correlation, cardinality, privacy, and actionable diagnostics.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Observability engineering for useful logs, metrics, traces, correlation, cardinality, privacy, and actionable diagnostics."
  layer: foundations
---

# Observability

Own user-impact questions, signal ownership, context propagation, cardinality budgets, redaction, sampling, and dashboard/alert validation. Activate for tasks that explicitly involve observability, metrics, logs, traces; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

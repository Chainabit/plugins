---
name: refactoring
description: Safe refactoring for responsibility boundaries, behavior preservation, dependency direction, and incremental verification.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Safe refactoring for responsibility boundaries, behavior preservation, dependency direction, and incremental verification."
  layer: foundations
---

# Refactoring

Own current behavior and callers, seam selection, invariant preservation, small reversible steps, and focused plus integration tests. Activate for tasks that explicitly involve refactoring, design, behavior-preservation; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

---
name: api-design
description: API design for stable contracts, validation, errors, pagination, compatibility, security, and consumer-oriented evolution.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "API design for stable contracts, validation, errors, pagination, compatibility, security, and consumer-oriented evolution."
  layer: foundations
---

# API Design

Own existing contract and clients, resource ownership, idempotency, versioning strategy, error semantics, and contract-level verification. Activate for tasks that explicitly involve api, contracts, versioning, idempotency; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

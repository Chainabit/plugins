---
name: debugging
description: Evidence-driven debugging for reproduction, hypothesis testing, root causes, minimal fixes, and regression proof.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Evidence-driven debugging for reproduction, hypothesis testing, root causes, minimal fixes, and regression proof."
  layer: foundations
---

# Debugging

Own logs/traces/configuration and recent changes, smallest reproduction, invariant violation, causal fix, and regression test or measurement. Activate for tasks that explicitly involve debugging, root-cause, reproduction, diagnosis; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

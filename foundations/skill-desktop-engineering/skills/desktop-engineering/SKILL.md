...
description: Desktop engineering for application lifecycle, native integration, packaging, updates, storage, accessibility, and platform variation.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Desktop engineering for application lifecycle, native integration, packaging, updates, storage, accessibility, and platform variation."
  layer: foundations
---

# Desktop Engineering

Own target OS evidence, process and window ownership, filesystem permissions, signing/update channels, offline behavior, and platform matrix tests. Activate for tasks that explicitly involve desktop, macos, windows, linux; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

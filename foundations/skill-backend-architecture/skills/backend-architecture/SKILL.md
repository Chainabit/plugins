...
description: Backend architecture for bounded contexts, application boundaries, persistence seams, integration contracts, and operational behavior.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Backend architecture for bounded contexts, application boundaries, persistence seams, integration contracts, and operational behavior."
  layer: foundations
---

# Backend Architecture

Own actual dependency direction, state ownership, transaction boundaries, failure modes, and a minimal architecture decision record. Activate for tasks that explicitly involve backend, architecture, boundaries; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

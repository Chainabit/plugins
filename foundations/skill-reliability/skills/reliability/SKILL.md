---
name: reliability
description: Reliability engineering for SLOs, graceful degradation, back-pressure, recovery, capacity, and operational readiness.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Reliability engineering for SLOs, graceful degradation, back-pressure, recovery, capacity, and operational readiness."
  layer: foundations
---

# Reliability Engineering

Own service objectives, dependency failure behavior, load shedding, recovery time, runbook ownership, and failure-drill evidence. Activate for tasks that explicitly involve reliability, slo, resilience, capacity; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

...
description: Event-driven design for durable event contracts, ownership, ordering, replay, delivery, and consumer evolution.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Event-driven design for durable event contracts, ownership, ordering, replay, delivery, and consumer evolution."
  layer: foundations
---

# Event-Driven Design

Own event ownership, schema compatibility, partition/order assumptions, outbox or inbox behavior, replay safety, and observable lag. Activate for tasks that explicitly involve events, messaging, outbox, streaming; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

...
description: Distributed-systems reasoning for time, retries, consistency, partitions, coordination, and failure-aware designs.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Distributed-systems reasoning for time, retries, consistency, partitions, coordination, and failure-aware designs."
  layer: foundations
---

# Distributed Systems

Own system topology, delivery guarantees, clocks, retry budgets, idempotency keys, consistency requirements, and fault-injection evidence. Activate for tasks that explicitly involve distributed-systems, consistency, retries, partitions; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

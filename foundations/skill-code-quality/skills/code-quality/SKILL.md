---
name: code-quality
description: Code-quality engineering for static analysis, complexity, duplication, conventions, debt triage, and actionable quality gates.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Code-quality engineering for static analysis, complexity, duplication, conventions, debt triage, and actionable quality gates."
  layer: foundations
---

# Code Quality

Own project-local lint/type rules, signal versus noise, ownership of violations, incremental baselines, and behavior-preserving cleanup. Activate for tasks that explicitly involve quality, lint, static-analysis, complexity; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

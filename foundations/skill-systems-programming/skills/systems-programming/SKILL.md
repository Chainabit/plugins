...
description: Systems-programming design for resources, processes, memory, I/O, portability, ABI contracts, and defensive operations.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Systems-programming design for resources, processes, memory, I/O, portability, ABI contracts, and defensive operations."
  layer: foundations
---

# Systems Programming

Own resource lifecycle, syscall/error surfaces, buffering, signal handling, privilege boundaries, portability matrix, and leak/crash evidence. Activate for tasks that explicitly involve systems, memory, io, abi; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

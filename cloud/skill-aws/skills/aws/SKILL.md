---
name: aws
description: AWS engineering for account boundaries, IAM least privilege, networking, managed services, observability, and cost-aware delivery.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "AWS engineering for account boundaries, IAM least privilege, networking, managed services, observability, and cost-aware delivery."
  layer: cloud
---

# AWS

Own actual account/region and IaC evidence, role trust, data paths, encryption keys, service quotas, audit signals, and rollback plan. Activate for tasks that explicitly involve aws, iam, cloud, least-privilege; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

---
name: gcp
description: Google Cloud engineering for projects, IAM, service accounts, networking, managed runtimes, data protection, and operations.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Google Cloud engineering for projects, IAM, service accounts, networking, managed runtimes, data protection, and operations."
  layer: cloud
---

# Google Cloud

Own project/folder boundaries, service-account scope, VPC paths, workload identity, audit logs, quotas, and tested rollout behavior. Activate for tasks that explicitly involve gcp, google-cloud, iam, cloud-run; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

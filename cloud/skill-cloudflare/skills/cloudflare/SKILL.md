---
name: cloudflare
description: Cloudflare engineering for Workers, edge routing, DNS, caching, durable state, secrets, and deployment safety.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Cloudflare engineering for Workers, edge routing, DNS, caching, durable state, secrets, and deployment safety."
  layer: cloud
---

# Cloudflare

Own account/zone bindings, isolate runtime limits, cache keys, durable-object ownership, token secrets, route scope, and preview/production separation. Activate for tasks that explicitly involve cloudflare, workers, edge, dns; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

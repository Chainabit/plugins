...
description: LLM application engineering for prompt boundaries, retrieval, structured outputs, tool use, evaluation, cost, and safety.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "LLM application engineering for prompt boundaries, retrieval, structured outputs, tool use, evaluation, cost, and safety."
  layer: ai
---

# LLM Applications

Own model/version and provider evidence, untrusted content boundaries, schema validation, retrieval grounding, tool authorization, eval set, and spend limits. Activate for tasks that explicitly involve llm, rag, prompts, tools; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

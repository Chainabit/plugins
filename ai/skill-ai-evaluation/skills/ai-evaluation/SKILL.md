---
name: ai-evaluation
description: AI evaluation engineering for task metrics, datasets, regressions, human review, adversarial cases, and release gates.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "AI evaluation engineering for task metrics, datasets, regressions, human review, adversarial cases, and release gates."
  layer: ai
---

# AI Evaluation

Own decision objective, representative and held-out data, rubric ownership, variance, privacy, red-team cases, threshold rationale, and reproducible reports. Activate for tasks that explicitly involve ai-evaluation, benchmarks, red-team, metrics; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

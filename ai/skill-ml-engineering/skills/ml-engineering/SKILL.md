---
name: ml-engineering
description: ML engineering for reproducible data, training, evaluation, serving, drift, lineage, and safe model lifecycle.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "ML engineering for reproducible data, training, evaluation, serving, drift, lineage, and safe model lifecycle."
  layer: ai
---

# ML Engineering

Own dataset and feature lineage, experiment reproducibility, leakage checks, metric slices, model/artifact registry, serving SLOs, and drift thresholds. Activate for tasks that explicitly involve machine-learning, mlops, evaluation, drift; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

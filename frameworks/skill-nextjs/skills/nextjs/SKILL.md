---
name: nextjs
description: Next.js engineering for server/client boundaries, routing, rendering modes, caching, data access, security, and deployable builds.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Next.js engineering for server/client boundaries, routing, rendering modes, caching, data access, security, and deployable builds."
  layer: framework
---

# Next.js

Own Next version and router evidence, server-only secrets, cache invalidation, hydration boundaries, headers, and production build behavior. Activate for tasks that explicitly involve nextjs, react, ssr, app-router; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

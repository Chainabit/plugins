---
name: aspnet-core
description: ASP.NET Core engineering for middleware, DI lifetimes, minimal APIs or MVC, EF Core, auth, and observable services.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "ASP.NET Core engineering for middleware, DI lifetimes, minimal APIs or MVC, EF Core, auth, and observable services."
  layer: framework
---

# ASP.NET Core

Own hosting model and target framework evidence, middleware order, DI lifetime correctness, cancellation, authorization policies, and integration tests. Activate for tasks that explicitly involve aspnet, dotnet, middleware, ef-core; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

---
name: gin
description: Gin engineering for Go HTTP handlers, middleware, binding, error contracts, observability, and production service tests.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Gin engineering for Go HTTP handlers, middleware, binding, error contracts, observability, and production service tests."
  layer: framework
---

# Gin

Own router ownership, binding validation, context cancellation, middleware ordering, structured errors, and race-safe handler tests. Activate for tasks that explicitly involve gin, go, http, middleware; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

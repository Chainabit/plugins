---
name: nuxt
description: Nuxt engineering for composables, server routes, rendering modes, modules, runtime config, and deploy-safe Vue applications.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Nuxt engineering for composables, server routes, rendering modes, modules, runtime config, and deploy-safe Vue applications."
  layer: framework
---

# Nuxt

Own Nuxt/Vue version evidence, server/client config separation, Nitro handlers, payload caching, route middleware, and generated output checks. Activate for tasks that explicitly involve nuxt, vue, nitro, ssr; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

---
name: dotnet-maui
description: .NET MAUI engineering for cross-platform UI, lifecycle, navigation, native capabilities, packaging, and testable state.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: ".NET MAUI engineering for cross-platform UI, lifecycle, navigation, native capabilities, packaging, and testable state."
  layer: framework
---

# .NET MAUI

Own target platforms and handlers, lifecycle ownership, UI-thread boundaries, capability permissions, offline state, and platform-specific verification. Activate for tasks that explicitly involve maui, dotnet, mobile, desktop; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

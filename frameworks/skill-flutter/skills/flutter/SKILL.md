---
name: flutter
description: Flutter engineering for widget boundaries, state ownership, rendering performance, platform channels, and release testing.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Flutter engineering for widget boundaries, state ownership, rendering performance, platform channels, and release testing."
  layer: framework
---

# Flutter

Own Flutter/Dart version evidence, widget versus domain state, rebuild cost, isolate work, platform-channel contracts, accessibility, and golden/integration tests. Activate for tasks that explicitly involve flutter, dart, widgets, platform-channels; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

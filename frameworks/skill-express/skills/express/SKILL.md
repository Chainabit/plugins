---
name: express
description: Express engineering for middleware composition, routing, validation, error boundaries, security headers, and testable Node services.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Express engineering for middleware composition, routing, validation, error boundaries, security headers, and testable Node services."
  layer: framework
---

# Express

Own middleware order, async error propagation, request lifecycle, schema validation, trust-proxy settings, and isolated HTTP tests. Activate for tasks that explicitly involve express, node, middleware, http; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

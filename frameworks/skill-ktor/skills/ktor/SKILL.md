---
name: ktor
description: Ktor engineering for Kotlin pipelines, plugins, coroutines, serialization, authentication, and deployable services.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Ktor engineering for Kotlin pipelines, plugins, coroutines, serialization, authentication, and deployable services."
  layer: framework
---

# Ktor

Own application pipeline order, coroutine scope ownership, content negotiation, auth providers, structured errors, and engine-specific tests. Activate for tasks that explicitly involve ktor, kotlin, coroutines, http; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

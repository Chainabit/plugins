---
name: vue
description: Vue engineering for component contracts, reactivity, composables, routing, state, accessibility, and tested browser behavior.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Vue engineering for component contracts, reactivity, composables, routing, state, accessibility, and tested browser behavior."
  layer: framework
---

# Vue

Own Vue version and compiler mode, reactive ownership, composable side effects, key stability, SSR boundaries, and component behavior tests. Activate for tasks that explicitly involve vue, reactivity, composition-api, vite; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

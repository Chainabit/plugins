---
name: micronaut
description: Micronaut engineering for compile-time DI, HTTP clients, configuration, validation, reactive execution, and native deployment.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Micronaut engineering for compile-time DI, HTTP clients, configuration, validation, reactive execution, and native deployment."
  layer: framework
---

# Micronaut

Own annotation processing evidence, bean scopes, non-blocking boundaries, config precedence, security filters, and startup/runtime tests. Activate for tasks that explicitly involve micronaut, java, kotlin, aot; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

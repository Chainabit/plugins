---
name: quarkus
description: Quarkus engineering for build-time augmentation, CDI, REST, reactive code, configuration, native images, and cloud deployment.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Quarkus engineering for build-time augmentation, CDI, REST, reactive code, configuration, native images, and cloud deployment."
  layer: framework
---

# Quarkus

Own Quarkus platform alignment, CDI scopes, blocking/reactive execution, config profiles, native-image reflection, and integration checks. Activate for tasks that explicitly involve quarkus, java, graalvm, cloud-native; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

---
name: laravel
description: Laravel engineering for application boundaries, Eloquent invariants, queues, configuration, authorization, and production tests.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Laravel engineering for application boundaries, Eloquent invariants, queues, configuration, authorization, and production tests."
  layer: framework
---

# Laravel

Own versioned Laravel structure, request-to-domain flow, model/query ownership, queue idempotency, policies, migrations, and feature tests. Activate for tasks that explicitly involve laravel, php, eloquent, queues; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

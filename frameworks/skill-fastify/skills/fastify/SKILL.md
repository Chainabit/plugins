---
name: fastify
description: Fastify engineering for schema-first routes, plugin encapsulation, lifecycle hooks, serialization, and high-throughput Node services.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Fastify engineering for schema-first routes, plugin encapsulation, lifecycle hooks, serialization, and high-throughput Node services."
  layer: framework
---

# Fastify

Own Fastify version and plugin scope, JSON schema ownership, hook order, serializer behavior, error mapping, and benchmarked route tests. Activate for tasks that explicitly involve fastify, node, schemas, plugins; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

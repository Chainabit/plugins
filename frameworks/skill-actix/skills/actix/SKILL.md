---
name: actix
description: Actix Web engineering for Rust extractors, actors, async state, error responses, middleware, and safe high-performance APIs.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Actix Web engineering for Rust extractors, actors, async state, error responses, middleware, and safe high-performance APIs."
  layer: framework
---

# Actix Web

Own runtime and feature flags, extractor ownership, shared state synchronization, cancellation, error mapping, and criterion/load evidence. Activate for tasks that explicitly involve actix-web, rust, async, extractors; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

---
name: symfony
description: Symfony engineering for bundles, dependency injection, console commands, Messenger, HTTP boundaries, and secure configuration.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Symfony engineering for bundles, dependency injection, console commands, Messenger, HTTP boundaries, and secure configuration."
  layer: framework
---

# Symfony

Own container wiring, autoconfiguration evidence, Messenger retry semantics, event ownership, validation, secrets, and kernel-level tests. Activate for tasks that explicitly involve symfony, php, messenger, doctrine; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

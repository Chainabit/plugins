---
name: react-native
description: React Native engineering for component state, native modules, navigation, platform differences, performance, and release validation.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "React Native engineering for component state, native modules, navigation, platform differences, performance, and release validation."
  layer: framework
---

# React Native

Own React Native and native SDK evidence, JS/native ownership, bridge cost, permissions, offline behavior, accessibility, and device tests. Activate for tasks that explicitly involve react-native, mobile, ios, android; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

---
name: axum
description: Axum engineering for Rust routers, extractors, Tower layers, state, error typing, and observable async services.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Axum engineering for Rust routers, extractors, Tower layers, state, error typing, and observable async services."
  layer: framework
---

# Axum

Own state ownership, extractor rejection contracts, Tower layer order, Send bounds, graceful shutdown, and integration tests. Activate for tasks that explicitly involve axum, rust, tower, tokio; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

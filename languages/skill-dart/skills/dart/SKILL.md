---
name: dart
description: Dart engineering for sound null safety, isolates, packages, async code, testing, and Flutter-independent libraries.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Dart engineering for sound null safety, isolates, packages, async code, testing, and Flutter-independent libraries."
  layer: language
---

# Dart

Own pubspec and SDK constraints, isolate message ownership, async error propagation, package APIs, analyzer rules, and deterministic tests. Activate for tasks that explicitly involve dart, pub, isolates, null-safety; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

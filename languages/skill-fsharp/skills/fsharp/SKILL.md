---
name: fsharp
description: F# engineering for discriminated unions, computation expressions, .NET interop, project files, and functional domain modeling.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "F# engineering for discriminated unions, computation expressions, .NET interop, project files, and functional domain modeling."
  layer: language
---

# F#

Own domain types and exhaustive matching, computation-expression scope, .NET boundary contracts, Paket/NuGet evidence, and behavior-focused tests. Activate for tasks that explicitly involve f-sharp, dotnet, functional, unions; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

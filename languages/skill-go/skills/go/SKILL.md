---
name: go
description: Go engineering for modules, interfaces, goroutines, channels, errors, testing, and production services.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Go engineering for modules, interfaces, goroutines, channels, errors, testing, and production services."
  layer: language
---

# Go

Own package boundaries, interface ownership, goroutine cancellation, context propagation, module hygiene, and race-tested services. Activate for tasks that explicitly involve go, golang, goroutines, modules; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

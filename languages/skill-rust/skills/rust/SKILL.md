---
name: rust
description: Rust engineering for ownership, lifetimes, traits, async runtimes, crates, and safe systems performance.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Rust engineering for ownership, lifetimes, traits, async runtimes, crates, and safe systems performance."
  layer: language
---

# Rust

Own ownership and borrowing, trait-based boundaries, Cargo workspaces, async Send/Sync behavior, FFI safety, and benchmark evidence. Activate for tasks that explicitly involve rust, cargo, ownership, tokio; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

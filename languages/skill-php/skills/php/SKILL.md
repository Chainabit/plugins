---
name: php
description: Modern PHP engineering for Composer packages, strict types, namespaces, errors, security, and maintainable services.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Modern PHP engineering for Composer packages, strict types, namespaces, errors, security, and maintainable services."
  layer: language
---

# PHP

Own Composer and autoload evidence, strict typing, dependency injection, exception boundaries, PHP-FPM/runtime behavior, and secure input handling. Activate for tasks that explicitly involve php, composer, psr, php-fpm; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

---
name: ocaml
description: OCaml engineering for algebraic types, modules, effects, dune builds, interoperability, and tested native code.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "OCaml engineering for algebraic types, modules, effects, dune builds, interoperability, and tested native code."
  layer: language
---

# OCaml

Own module signatures, exhaustiveness, mutable-state isolation, dune workspace evidence, runtime representation, and property-based validation. Activate for tasks that explicitly involve ocaml, dune, modules, types; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

---
name: sql
description: SQL engineering for relational modeling, query correctness, transactions, indexes, migrations, and safe parameterized access.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "SQL engineering for relational modeling, query correctness, transactions, indexes, migrations, and safe parameterized access."
  layer: language
---

# SQL

Own dialect and schema evidence, transaction isolation, null and cardinality semantics, query plans, migration reversibility, and injection-safe parameters. Activate for tasks that explicitly involve sql, transactions, indexes, migrations; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

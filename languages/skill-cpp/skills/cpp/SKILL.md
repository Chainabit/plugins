---
name: cpp
description: C++ engineering for RAII, value semantics, templates, concurrency, ABI stability, and tested performance.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "C++ engineering for RAII, value semantics, templates, concurrency, ABI stability, and tested performance."
  layer: language
---

# C++

Own RAII ownership, modern standard selection, move/copy contracts, template constraints, thread safety, ABI compatibility, and sanitizer evidence. Activate for tasks that explicitly involve c++, cpp, raii, cmake; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

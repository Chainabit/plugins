---
name: shell
description: Portable shell engineering for strict modes, process boundaries, quoting, pipelines, cleanup, and safe automation.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Portable shell engineering for strict modes, process boundaries, quoting, pipelines, cleanup, and safe automation."
  layer: language
---

# Shell and Bash

Own actual shell dialect, exit-status propagation, word-splitting prevention, trap cleanup, temporary-file ownership, and dry-runable commands. Activate for tasks that explicitly involve shell, bash, posix, scripting; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

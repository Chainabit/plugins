...
Own actual runtime and module mode, promise cancellation, prototype and coercion hazards, package boundaries, and browser/server security. Activate for tasks that explicitly involve javascript, ecmascript, node, modules; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

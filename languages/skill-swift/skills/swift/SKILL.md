---
name: swift
description: Swift engineering for value semantics, protocols, concurrency, actors, packages, and safe Apple-platform code.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Swift engineering for value semantics, protocols, concurrency, actors, packages, and safe Apple-platform code."
  layer: language
---

# Swift

Own Sendable and actor isolation, ownership/value choices, Swift Package Manager, async cancellation, interoperability, and XCTest evidence. Activate for tasks that explicitly involve swift, concurrency, actors, spm; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

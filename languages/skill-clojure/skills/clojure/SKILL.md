---
name: clojure
description: Clojure engineering for immutable data, protocols, sequences, concurrency primitives, deps.edn, and JVM services.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Clojure engineering for immutable data, protocols, sequences, concurrency primitives, deps.edn, and JVM services."
  layer: language
---

# Clojure

Own persistent data ownership, protocol seams, lazy sequence realization, atom/ref/agent semantics, dependency aliases, and instrumentation. Activate for tasks that explicitly involve clojure, immutable, deps-edn, jvm; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

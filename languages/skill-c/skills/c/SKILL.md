---
name: c
description: C engineering for memory ownership, ABI boundaries, compilation, portability, testing, and defensive systems code.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "C engineering for memory ownership, ABI boundaries, compilation, portability, testing, and defensive systems code."
  layer: language
---

# C

Own allocation ownership, lifetime documentation, integer and buffer safety, compiler flags, ABI compatibility, sanitizers, and cross-platform builds. Activate for tasks that explicitly involve c, memory-safety, abi, cmake; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

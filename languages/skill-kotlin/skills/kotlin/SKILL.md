---
name: kotlin
description: Kotlin engineering for null safety, coroutines, sealed types, Gradle builds, interoperability, and tests.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Kotlin engineering for null safety, coroutines, sealed types, Gradle builds, interoperability, and tests."
  layer: language
---

# Kotlin

Own nullability contracts, structured concurrency, coroutine dispatchers, JVM/Android interop, Gradle source sets, and serialization boundaries. Activate for tasks that explicitly involve kotlin, coroutines, gradle, jvm; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

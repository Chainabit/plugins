---
name: haskell
description: Haskell engineering for purity boundaries, typeclasses, effects, laziness, Cabal or Stack, and reliable property tests.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Haskell engineering for purity boundaries, typeclasses, effects, laziness, Cabal or Stack, and reliable property tests."
  layer: language
---

# Haskell

Own pure/effectful ownership, typeclass coherence, strictness and space leaks, package resolver evidence, FFI boundaries, and QuickCheck properties. Activate for tasks that explicitly involve haskell, ghc, cabal, purity; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

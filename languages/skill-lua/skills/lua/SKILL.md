---
name: lua
description: Lua engineering for module environments, metatables, coroutines, embedding boundaries, errors, and testable scripts.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Lua engineering for module environments, metatables, coroutines, embedding boundaries, errors, and testable scripts."
  layer: language
---

# Lua

Own Lua version and host API evidence, module return contracts, metatable scope, coroutine lifecycle, sandboxed embedding, and deterministic tests. Activate for tasks that explicitly involve lua, coroutines, metatables, embedding; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

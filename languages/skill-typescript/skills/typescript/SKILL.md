---
name: typescript
description: TypeScript engineering for type-safe boundaries, generics, modules, runtime validation, builds, and maintainable APIs.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "TypeScript engineering for type-safe boundaries, generics, modules, runtime validation, builds, and maintainable APIs."
  layer: language
---

# TypeScript

Own tsconfig and module-resolution evidence, type/runtime boundary validation, discriminated unions, declaration output, and strictness migration. Activate for tasks that explicitly involve typescript, tsconfig, types, generics; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

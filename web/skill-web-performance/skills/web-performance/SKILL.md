...
description: Web performance engineering for budgets, loading, rendering, network waterfalls, runtime cost, and measurable regressions.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Web performance engineering for budgets, loading, rendering, network waterfalls, runtime cost, and measurable regressions."
  layer: web
---

# Web Performance

Own real user or trace evidence, Core Web Vitals, bundle ownership, cache policy, long tasks, and before/after measurement. Activate for tasks that explicitly involve web-performance, vitals, bundle, profiling; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

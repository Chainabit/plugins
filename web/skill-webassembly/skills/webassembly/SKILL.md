---
name: webassembly
description: WebAssembly engineering for module boundaries, host capabilities, memory, ABI, tooling, and secure browser or server execution.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "WebAssembly engineering for module boundaries, host capabilities, memory, ABI, tooling, and secure browser or server execution."
  layer: web
---

# WebAssembly

Own target/runtime evidence, linear-memory ownership, capability-limited imports, ABI versioning, size budgets, and cross-runtime tests. Activate for tasks that explicitly involve wasm, webassembly, abi, wasi; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

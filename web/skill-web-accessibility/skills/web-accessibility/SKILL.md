...
description: Web accessibility engineering for semantic HTML, keyboard flow, focus, names, contrast, motion, and assistive-technology validation.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Web accessibility engineering for semantic HTML, keyboard flow, focus, names, contrast, motion, and assistive-technology validation."
  layer: web
---

# Web Accessibility

Own actual interaction and component evidence, semantic ownership, focus restoration, accessible names, reduced motion, and automated plus manual checks. Activate for tasks that explicitly involve accessibility, wcag, aria, keyboard; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

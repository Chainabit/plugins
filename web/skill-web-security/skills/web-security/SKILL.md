---
name: web-security
description: Web security engineering for browser trust boundaries, XSS, CSRF, cookies, CSP, CORS, and secure client-server flows.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Web security engineering for browser trust boundaries, XSS, CSRF, cookies, CSP, CORS, and secure client-server flows."
  layer: web
---

# Web Security

Own actual origin and auth model, encoding context, cookie flags, CSRF tokens, CSP report behavior, CORS allowlists, and adversarial tests. Activate for tasks that explicitly involve xss, csrf, csp, cors; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

...
description: PWA engineering for service workers, caching, offline states, installability, updates, and resilient web UX.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "PWA engineering for service workers, caching, offline states, installability, updates, and resilient web UX."
  layer: web
---

# Progressive Web Apps

Own cache ownership and invalidation, offline data consistency, update activation, manifest scope, secure contexts, and repeatable network-condition tests. Activate for tasks that explicitly involve pwa, service-worker, offline, web; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

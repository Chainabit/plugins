---
name: grpc
description: gRPC engineering for protobuf contracts, deadlines, streaming, compatibility, interceptors, and service observability.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "gRPC engineering for protobuf contracts, deadlines, streaming, compatibility, interceptors, and service observability."
  layer: web
---

# gRPC

Own proto ownership and evolution, deadline propagation, status mapping, stream back-pressure, TLS/auth boundaries, and conformance tests. Activate for tasks that explicitly involve grpc, protobuf, streaming, rpc; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

---
name: graphql
description: GraphQL engineering for schema ownership, resolver boundaries, authorization, N+1 control, evolution, and contract testing.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "GraphQL engineering for schema ownership, resolver boundaries, authorization, N+1 control, evolution, and contract testing."
  layer: web
---

# GraphQL

Own schema versus resolver responsibility, field-level auth, batching/data loaders, query limits, introspection policy, and operation tests. Activate for tasks that explicitly involve graphql, schema, resolvers, federation; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

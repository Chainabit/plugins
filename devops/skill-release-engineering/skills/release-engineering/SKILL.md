...
description: Release engineering for versioning, changelogs, artifacts, provenance, rollout strategy, rollback, and reproducible delivery.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Release engineering for versioning, changelogs, artifacts, provenance, rollout strategy, rollback, and reproducible delivery."
  layer: devops
---

# Release Engineering

Own actual release source and consumers, immutable artifacts, signing/provenance, compatibility window, staged rollout, and rollback rehearsal. Activate for tasks that explicitly involve releases, versioning, provenance, rollback; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

---
name: gitlab-ci
description: GitLab CI engineering for staged pipelines, runners, artifacts, caching, protected variables, environments, and controlled deployment.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "GitLab CI engineering for staged pipelines, runners, artifacts, caching, protected variables, environments, and controlled deployment."
  layer: devops
---

# GitLab CI

Own runner trust and tags, pipeline graph, variable protection, cache correctness, artifact retention, merge-request rules, and repeatable jobs. Activate for tasks that explicitly involve gitlab-ci, ci, runners, pipelines; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

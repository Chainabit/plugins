---
name: github-actions
description: GitHub Actions engineering for least-privilege workflows, deterministic jobs, caching, environments, artifacts, and safe releases.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "GitHub Actions engineering for least-privilege workflows, deterministic jobs, caching, environments, artifacts, and safe releases."
  layer: devops
---

# GitHub Actions

Own workflow triggers and permissions, action pinning, secret scope, cache keys, concurrency cancellation, artifact provenance, and fork safety. Activate for tasks that explicitly involve github-actions, ci, workflows, supply-chain; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

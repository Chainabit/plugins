...
description: Property-testing engineering for invariants, generators, shrinking, state models, and reproducible counterexamples.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Property-testing engineering for invariants, generators, shrinking, state models, and reproducible counterexamples."
  layer: testing
---

# Property Testing

Own domain invariants and valid input space, generator bias, shrink quality, seed capture, side-effect isolation, and minimal failing examples. Activate for tasks that explicitly involve property-testing, quickcheck, invariants, fuzzing; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

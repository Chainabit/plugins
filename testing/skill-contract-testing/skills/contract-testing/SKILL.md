...
description: Contract-testing engineering for provider/consumer ownership, schema compatibility, interactions, and independently deployable services.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Contract-testing engineering for provider/consumer ownership, schema compatibility, interactions, and independently deployable services."
  layer: testing
---

# Contract Testing

Own real consumer expectations, contract ownership, compatibility rules, test data privacy, provider verification, and versioned failure reports. Activate for tasks that explicitly involve contract-testing, pact, api, compatibility; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

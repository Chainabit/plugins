---
name: test-strategy
description: Test strategy for risk-based coverage, test boundaries, fixtures, failure paths, determinism, and useful feedback loops.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Test strategy for risk-based coverage, test boundaries, fixtures, failure paths, determinism, and useful feedback loops."
  layer: testing
---

# Test Strategy

Own system risks and contracts, unit/integration/e2e ownership, fixture lifecycle, isolation, timing control, mutation or coverage signal, and exit criteria. Activate for tasks that explicitly involve testing, strategy, coverage, fixtures; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

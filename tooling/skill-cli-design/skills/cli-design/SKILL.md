---
name: cli-design
description: CLI design for discoverable commands, safe defaults, structured output, config precedence, errors, and automation compatibility.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "CLI design for discoverable commands, safe defaults, structured output, config precedence, errors, and automation compatibility."
  layer: tooling
---

# CLI Design

Own existing command conventions, argument ownership, exit codes, TTY versus machine output, secret redaction, dry-run behavior, and repeatable tests. Activate for tasks that explicitly involve cli, command-line, ux, automation; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

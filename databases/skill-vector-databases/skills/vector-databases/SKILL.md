...
description: Vector-database engineering for embedding lineage, index choice, filtering, recall/latency trade-offs, and safe retrieval systems.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Vector-database engineering for embedding lineage, index choice, filtering, recall/latency trade-offs, and safe retrieval systems."
  layer: databases
---

# Vector Databases

Own embedding model/version ownership, dimension and normalization, metadata filters, index parameters, freshness, evaluation set, and privacy boundaries. Activate for tasks that explicitly involve vectors, embeddings, retrieval, ann; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

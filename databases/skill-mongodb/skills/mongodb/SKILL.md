---
name: mongodb
description: MongoDB engineering for document boundaries, indexes, aggregation, transactions, schema evolution, and safe operational access.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "MongoDB engineering for document boundaries, indexes, aggregation, transactions, schema evolution, and safe operational access."
  layer: databases
---

# MongoDB

Own document ownership, cardinality, index/selectivity evidence, validation, consistency level, migration strategy, and query-profile checks. Activate for tasks that explicitly involve mongodb, documents, aggregation, indexes; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

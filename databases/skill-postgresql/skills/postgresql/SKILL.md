---
name: postgresql
description: PostgreSQL engineering for schema design, transactions, indexes, query plans, extensions, migrations, and operational safety.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "PostgreSQL engineering for schema design, transactions, indexes, query plans, extensions, migrations, and operational safety."
  layer: databases
---

# PostgreSQL

Own server/version and schema evidence, MVCC/isolation, lock behavior, EXPLAIN plans, extension lifecycle, least-privilege roles, and migration rehearsal. Activate for tasks that explicitly involve postgresql, postgres, sql, mvcc; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

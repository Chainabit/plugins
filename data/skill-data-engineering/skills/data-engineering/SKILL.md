...
description: Data-engineering design for reliable pipelines, schemas, quality, lineage, backfills, partitioning, and operational recovery.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Data-engineering design for reliable pipelines, schemas, quality, lineage, backfills, partitioning, and operational recovery."
  layer: data
---

# Data Engineering

Own source ownership, freshness and completeness contracts, schema evolution, idempotent checkpoints, late data, privacy, and backfill validation. Activate for tasks that explicitly involve data-engineering, pipelines, lineage, etl; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

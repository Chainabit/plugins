...
description: Stream-processing engineering for partitions, windows, watermarks, state, delivery guarantees, and replayable consumers.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Stream-processing engineering for partitions, windows, watermarks, state, delivery guarantees, and replayable consumers."
  layer: data
---

# Stream Processing

Own broker topology, key/order assumptions, event-time semantics, state checkpoints, lag/back-pressure, deduplication, and replay tests. Activate for tasks that explicitly involve streaming, kafka, windows, watermarks; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

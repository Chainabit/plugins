...
description: Supply-chain security for dependency provenance, lockfiles, signing, SBOMs, build isolation, and tamper-evident releases.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Supply-chain security for dependency provenance, lockfiles, signing, SBOMs, build isolation, and tamper-evident releases."
  layer: security
---

# Supply Chain Security

Own actual package managers and CI, transitive dependency paths, pinning policy, provenance attestations, secret scope, and reproducible verification. Activate for tasks that explicitly involve supply-chain, sbom, provenance, dependencies; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

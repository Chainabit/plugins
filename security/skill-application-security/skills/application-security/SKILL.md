...
description: Application-security engineering for input validation, authn/authz, secrets, dependency risk, secure errors, and defense in depth.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Application-security engineering for input validation, authn/authz, secrets, dependency risk, secure errors, and defense in depth."
  layer: security
---

# Application Security

Own real attack surface and trust boundaries, canonical validation, authorization ownership, secret handling, dependency advisories, and negative tests. Activate for tasks that explicitly involve appsec, authentication, authorization, secrets; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.

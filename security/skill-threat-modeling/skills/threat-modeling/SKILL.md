...
description: Threat modeling for assets, trust boundaries, abuse cases, mitigations, residual risk, and verifiable security decisions.
license: Apache-2.0
metadata:
  version: 1.0.0
  discovery: "Threat modeling for assets, trust boundaries, abuse cases, mitigations, residual risk, and verifiable security decisions."
  layer: security
---

# Threat Modeling

Own actual data flows and privileges, attacker capability, STRIDE or equivalent reasoning, mitigation ownership, abuse tests, and accepted residual risk. Activate for tasks that explicitly involve threat-modeling, stride, security, abuse-cases; do not activate for generic programming, unrelated technologies, or broad methodology that belongs to a foundation skill.
